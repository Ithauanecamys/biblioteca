...
app.get('/livros/editar', (req, res) => {
  ...
  // Simulação de livro com base no ID
  const livroMock = {
    1: { id: 1, titulo: 'Dom Casmurro', autor: 'Machado de Assis', ano: 1899, status: 'Disponível' },
    2: { id: 2, titulo: '1984', autor: 'George Orwell', ano: 1949, status: 'Emprestado' },
    3: { id: 3, titulo: 'O Pequeno Príncipe', autor: 'Saint-Exupéry', ano: 1943, status: 'Disponível' }
  };
  const livro = livroMock[id] || livroMock[1];
